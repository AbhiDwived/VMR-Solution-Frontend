...
const CheckoutInteractive = () => {
  ...
  const cartItems: CartItem[] = [
    {
      id: '1',
      name: 'Premium Plastic Flower Pot',
      variant: 'Large, Terracotta Brown',
      quantity: 2,
      price: 299,
      image: 'https://images.pexels.com/photos/1301856/pexels-photo-1301856.jpeg',
      alt: 'Large terracotta brown plastic flower pot with drainage holes on white background',
    },
    {
      id: '2',
      name: 'Plastic Storage Container Set',
      variant: 'Medium, 3 Pieces, Transparent',
      quantity: 1,
      price: 499,
      image: 'https://images.pexels.com/photos/4099354/pexels-photo-4099354.jpeg',
      alt: 'Set of three transparent plastic storage containers with blue lids stacked together',
    },
    {
      id: '3',
      name: 'Plastic Water Mug',
      variant: 'Small, Blue, 500ml',
      quantity: 4,
      price: 149,
      image: 'https://images.pexels.com/photos/6621451/pexels-photo-6621451.jpeg',
      alt: 'Blue plastic water mug with handle and measurement markings on side',
    },
  ];
